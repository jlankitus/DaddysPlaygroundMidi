...
public class GearInspector : Editor {
	...
	void OnSceneGUI() {
		...
		Handles.Disc(Quaternion.identity, gearTransform.position,gearTransform.up, baseRadius.x* handelScale, true, 0f);
		Handles.Disc(Quaternion.identity, gearTransform.position,gearTransform.up, gear.prefs.dk * handelScale, true, 0f);
